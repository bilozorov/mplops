...
def get_input_path(year, month):
    ...
    input_pattern = os.getenv('INPUT_FILE_PATTERN_WORNG', default_input_pattern)
    print(f'INPUT_FILE_PATTERN = {input_pattern.format(year=year, month=month)}')
...
def get_output_path(year, month):
    ...
    print(f'OUTPUT_FILE_PATTERN = {output_pattern.format(year=year, month=month)}')
